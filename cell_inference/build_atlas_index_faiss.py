# This script is used to build the index for similarity search using faiss.
#  It supports loading embeddings and meta labels from directories and add to faiss index. 
...
class FaissIndexBuilder:
    ...
    def _load_data(self):
        ...
        # model_dir = Path("/home/share/huadjyin/home/mengqiu/scGPT-main/train/saves/finetune/alldata/base/root_selfbin_c_no")
        ...
        if self.META_FROM_EMBEDDING and self.embedding_file_suffix == ".h5ad":
            ...
            if self.num_workers > 1:
                ...
                for file in tqdm(
                    ...
                    embedding = embed_adata.X  # shape: (4218, 512)
                    print('embedding1111111',embedding)
                    meta_label = embed_adata.obs[cell_type_key].values  # 原始细胞类型
...
if __name__ == "__main__":
    # Set options
    # embedding_dir = r"/home/share/huadjyin/home/mengqiu/Plantscdata/lmdb_anno/h5ad/root"
    # output_dir = r"/home/share/huadjyin/home/mengqiu/scGPT-main/train/saves/my_embedding/root_faiss"
    embedding_dir = r"/path/to/h5ad/file"
    output_dir = r"/path/to/output"
    embedding_file_suffix = ".h5ad"
    gpu = True
    index_desc = "PCA128,IVF8192_HNSW32,PQ32"
    num_workers = 1
